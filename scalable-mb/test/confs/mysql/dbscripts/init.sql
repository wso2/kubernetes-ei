...
DROP DATABASE IF EXISTS WSO2EI_MB_CONFIG_GOV_DB;
DROP DATABASE IF EXISTS WSO2EI_MB_DB;

CREATE DATABASE WSO2EI_USER_DB;
CREATE DATABASE WSO2EI_MB_CONFIG_GOV_DB;
...
GRANT ALL ON WSO2EI_MB_CONFIG_GOV_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';

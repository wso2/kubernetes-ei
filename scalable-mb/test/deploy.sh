...
kubectl create configmap mb-conf --from-file=../confs
kubectl create configmap mb-conf-axis2 --from-file=../confs/axis2/
kubectl create configmap mb-conf-datasources --from-file=../confs/datasources/
kubectl create configmap mysql-dbscripts --from-file=confs/mysql/dbscripts/

# MySQL
echoBold 'Deploying WSO2 Message Broker Databases...'
...
kubectl create -f ../message-broker-volume-claim.yaml
kubectl create -f ../volumes/persistent-volumes.yaml

# integrator
echoBold 'Deploying WSO2 Message Broker...'
kubectl create -f ../message-broker-service.yaml
kubectl create -f ../message-broker-deployment.yaml
sleep 30s

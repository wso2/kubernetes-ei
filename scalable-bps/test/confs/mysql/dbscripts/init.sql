...
DROP DATABASE IF EXISTS WSO2EI_BPS_USER_DB;
DROP DATABASE IF EXISTS WSO2EI_BPS_CONFIG_GOV_DB;
DROP DATABASE IF EXISTS WSO2EI_BPEL_DB;
DROP DATABASE IF EXISTS WSO2EI_BPMN_DB;

CREATE DATABASE WSO2EI_BPS_USER_DB;
CREATE DATABASE WSO2EI_BPS_CONFIG_GOV_DB;
CREATE DATABASE WSO2EI_BPEL_DB;
CREATE DATABASE WSO2EI_BPMN_DB;

CREATE USER IF NOT EXISTS 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2EI_BPS_USER_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2EI_BPS_CONFIG_GOV_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2EI_BPEL_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';
GRANT ALL ON WSO2EI_BPMN_DB.* TO 'wso2carbon'@'%' IDENTIFIED BY 'wso2carbon';

USE WSO2EI_BPS_USER_DB;

...
function progress_bar(){
  ...
  do
      ...
      if [[ $time_proc -gt 250 ]]
      then
          echoBold "\n\nSomething went wrong! Please Follow \"https://docs.google.com/document/d/11FvDtO4kUARgWR8NkJXypqxzOlcuTnsNIjkDQtXKh3w/edit?usp=sharing\" for more information\n"
          exit 2
      fi
  done

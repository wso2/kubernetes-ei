...
Change directory to `<KUBERNETES_HOME>/advanced/integrator-broker-analytics/scripts` and execute the `deploy.sh` or kubernetes provider specific shell script on the terminal.

...
* For using these Kubernetes resources,
    ...
    * Using Azurefiles on AKS,
        ...
        kubectl create -f <KUBERNETES_HOME>/advanced/integrator-analytics/extras/rdbms/mysql/mysql-persistent-volume-claim-azure.yaml
        ```
...
* Using Azurefiles,
  ...
  kubectl create -f <KUBERNETES_HOME>/advanced/integrator-analytics/integrator/integrator-volume-claims-azure.yaml
  ```
